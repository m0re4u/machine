...
from machine.util import DictList, Segmenter
...
class InstructionsPreprocessor(object):
    def __init__(self, model_name, load_vocab_from=None, segment_level='word', vocab_path='models'):
        ...
        if load_vocab_from is not None and os.path.exists(load_vocab_from):
            ...
            self.vocab = Vocabulary(os.path.join(vocab_path, model_name, 'vocab.json'))
...
class ObssPreprocessor:
    def __init__(self, model_name, obs_space=None, load_vocab_from=None, segment_level='word'):
        self.image_preproc = RawImagePreprocessor()
        self.instr_preproc = InstructionsPreprocessor(model_name, load_vocab_from, segment_level)
...
class IntObssPreprocessor(object):
    def __init__(self, model_name, obs_space, load_vocab_from=None, level_name=None, segment_level='words'):
        ...
        self.instr_preproc = InstructionsPreprocessor(load_vocab_from or model_name, segment_level)
        self.vocab = self.instr_preproc.vocab
        self.obs_space = {
